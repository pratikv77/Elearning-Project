...
<section class="meetings-page" id="meetings">
    ...
    <!--  message box -->
          ...
          <!-- 	  Sidebar Dashboard -->
  		 <div class="col-lg-3 my-lg-0 my-md-1">
            <div id="sidebar" class="bg-purple">
                <div class="h4 text-white">Zoom Accounts</div>
                <ul>    
                 <li > <a href="/viewallschedule" class="text-decoration-none d-flex align-items-start">
                    ...
                    <li class="active" > <a href="/viewAccounts" class="text-decoration-none d-flex align-items-start">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
       ...
       <div><a  class="btn btn-primary" href="/addzoomaccount">Add Account</a></div> 
         </div>
        ...
        <table class="table bg-light ">
            ...
            <tbody>
                <c:forEach items="${accounts}" var="accounts" varStatus="counter">
              <tr>
                <th scope="row">${counter.count}</th>
                <td>${accounts.zoom_username }</td>
                <td>${accounts.zoom_password}</td>
                <td>${accounts.zoom_account_details}</td>
                
               <td><a class="btn btn-primary" href="/updateaccount?id=${accounts.zoom_id}">Edit</a></td>  
   				<td><a class="btn btn-danger" href="/deleteaccount?id=${accounts.zoom_id}">Delete</a></td>  
              </tr>
            </c:forEach>             
            </tbody>
          </table>
